...
/**
 * Event triggered when a user adds a reaction on a module.
...
class reaction_added extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has added a reaction" .
    ...
    public static function get_name() {
        return get_string('eventreactionadded', 'block_point_view');
    }
    ...
    public function get_url() {
        return new \moodle_url('/blocks/point_view/overview.php',
                [ 'instanceid' => $this->other['blockid'], 'courseid' => $this->contextinstanceid ]);
    }
