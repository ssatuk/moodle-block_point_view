...
$string['cleanupreactionsconfirmation'] = 'Êtes-vous sûr de vouloir nettoyer (supprimer) les réactions des utilisateurs qui ne sont plus inscrits dans <b>{$a}</b> ? Cette action est irréversible.';
